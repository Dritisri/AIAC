class StudentRecord:
    ...
    def get_summary(self):
        return f"Student Name: {self.studentName}, ID: {self.student_id}, Courses: {', '.join(self.courses)}"
class Department:
    ...
    def department_summary(self):
        return f"Department: {self.dept_name}, Total Students Enrolled: {len(self.students)}"
